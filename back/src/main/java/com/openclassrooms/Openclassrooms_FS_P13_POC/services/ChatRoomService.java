...
import com.openclassrooms.Openclassrooms_FS_P13_POC.repository.ChatRoomRepository;
...
public class ChatRoomService {
	...
	public Optional<String> getChatRoomId(String senderId, String recipientId, boolean createNewRoomIfNoExists) {
		return chatRoomRepository.findBySenderIdAndRecipientId(senderId, recipientId).map(ChatRoom::getChatId)
				.or(() -> {
					if (createNewRoomIfNoExists) {
	...
	static String createChatId(String senderId, String recipientId) {
